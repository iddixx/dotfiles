;;; emms-state-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Emms-State mode' mode.  If the prefix argument is positive, enable the
...
evaluate `(default-value \\='emms-state-mode)'.

The mode's hook is called both when the mode is enabled and when it is
disabled.

(fn &optional ARG)" t)
(register-definition-prefixes "emms-state" '("emms-state"))

;;; End of scraped data

(provide 'emms-state-autoloads)
